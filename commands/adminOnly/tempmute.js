module.exports = {
  name: "tempmute",
  code: `
$channelSendMessage[$channelID;{newEmbed:{description:$username[$findMember[$message[1]]] was unmuted}
...
$onlyIf[$checkContains[$message[2];h;m;s]==true;{newEmbed:{description:Put a valid time (h,m,s)}{color:RED}}]
$onlyIf[$findMember[$message[1]]!=$authorID;]
$onlyIf[$message[2]!=;{newEmbed:{title:Error}{field:**Usage**:\`tempmute <member | userID> <time>\`}{color:RED}}]
$onlyIf[$getServerVar[muted]!=;{newEmbed:{description:Mute role role has not been configured, type \`$getServerVar[prefix]setmute\` to set it}{color:RED}}]
