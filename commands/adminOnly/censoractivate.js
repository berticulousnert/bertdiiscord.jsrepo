module.exports = {
  ...
  Success! censor is now **$replacetext[$replacetext[$message[5];true;enabled];false;disabled]**!
  ...
  > $getservervar[prefix]set-censor <antispam true/false> <caps true/false> <mass mention true/false> <mass emoji true/false> <anti links true/false> <badword true/false>\`\`\`}{color:FF0000}]
