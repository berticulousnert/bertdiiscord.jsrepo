...
$textsplit[$channelsendmessage[$getservervar[suggest_channel];{newEmbed: {author:$usertag:$authoravatar}{title:Suggestion #$sum[$getservervar[suggest_count];1]}{description:$message}{color:RED}{timestamp}{footer:$authorid}};yes]; ]
$deletecommand
