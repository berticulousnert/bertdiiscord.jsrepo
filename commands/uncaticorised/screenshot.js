...
name: "ss",
code: `
$title[1;Here's the website ss you requested]
$image[1;attachment://ss.png]
$color[1;$getUserVar[embedColor]]
$attachment[1;https://image.thum.io/get/width/1920/crop/675/noanimate/$replaceText[$replaceText[$checkContains[$message;https://];true;$message];false;https://$message];ss.png]
...
$argsCheck[>1;Provide a url for the site you want to screenshot. Example: \`#SEMI#ss popcat.xyz\` or \`#SEMI#ss https://popcat.xyz\`] $onlyIf[$getUserVar[command;$commandName]!=disabled;Command disabled]
`
})