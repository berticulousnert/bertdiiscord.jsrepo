A literal fork of the npm package discord.js-akinator, except with minor changes. The only reason I'm publishing this is for private use. But anyone is free to use it if they wish, As long as they follow the [License](https://github.com/WillTDA/Discord.js-Akinator-Package-Dev/blob/master/LICENSE).
<br>
PS: This readme is the exact clone of the one in [discord.js-akinator](https://npmjs.com/package/discord.js-akinator). I have not changed a single line exept this one and the one above.
<h1 align="center">
    🔮 Discord.js Akinator 🔮
</h1>
