...
var getFFprobeWrappedExecution = function (input) {
    ...
    if (typeof input === 'string') {
        return execa(ffprobe.path, __spreadArray(__spreadArray([], params, true), [input], false));
    }
    if (isStream(input)) {
        return execa(ffprobe.path, __spreadArray(__spreadArray([], params, true), ['-i', 'pipe:0'], false), {
            reject: false,
            input: input,
        });
    }
